...
const ImgLQIP = props => {
  ...
  return (
    <Img
      ...
      style={{filter: 'blur(10px)', transition: 'all 200ms ease-in-out'}}
      placeholderStyle={{opacity: '0.5', filter: 'blur(10px)', transform: 'scale(0.8)', transformOrigin: 'center', transition: 'all 100ms ease-in-out'}}
