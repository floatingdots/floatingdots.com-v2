...
export const query = graphql`
  ...
  query BlogArchiveJaTemplateQuery($skip: Int!, $limit: Int!, $currentDatetime: Date!, $language: String!) {
    ...
    blog: allSanityBlog(
      ...
      filter: { slug: { current: { ne: null } }, publishedAt: { lte: $currentDatetime }, title: { ja: { ne : null } } }
    ){
      edges {
        node {
          _type
